...
ActiveRecord::Schema.define(version: 2022_05_30_075857) do
  ...
  create_table "taggables", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "book_id", null: false
    t.bigint "tag_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["book_id"], name: "index_taggables_on_book_id"
  ...
  add_foreign_key "taggables", "books"
